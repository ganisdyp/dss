 ...
 /*   if($plant_id != 0) {
    ...
    <table class="table" style="border:none;width:100%;">
        <tr>
            ...
            <td style="border:none;width:50%;text-align:center;"><h2>MONTHLY TRUCK ANALYSIS REPORT</h2></td>
            <td style="border:none;width:25%;"></td>
        </tr>
    ...
    <table class="table" style="border:none;width:100%;">
        <tr>
            ...
            <td style="border:none;width:35%;text-align:center;"><h2>[ <?= date("n / Y",strtotime($_GET["month"])); ?> ]</h2></td>
            <td style="border:none;"></td>
        </tr>
    ...
    <table class="table" id="monthly-pdf">
      ...
      //  $prosessive_total = 0.00;
        ...
        <tr style="font-weight:bold;">
            ...
            <td colspan="1" style="background-color: #f3e97a;font-weight:bold;"><?= round($total_cost_2,2); ?></td>
            <td colspan="1" style="background-color: #f3e97a;font-weight:bold;">RM</td>
        </tr>
        </tbody>
    </table>
