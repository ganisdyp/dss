...
class SiteController extends Controller
{
     ...
     * @return string
     */
    public function actionMaterialaudit($plant_id = null, $filter = null)
    {
        ...
        return $this->render('material-audit', [
            /*'searchModel' => $searchModel, */
            'customers' => $customers,
            'grades' => $grades,
            'filter' => $filter,
     ...
     * @return string
     */
    public function actionMaterialauditpdf($plant_id = null, $filter = null)
    {
    ...
    /**
     * Displays monthly report (cashsale).
     *
     * @return string
     */
...
//];
    ...
    public function actionPdfcs($plant_id = null, $filter = null)
    {
        $model = new Cashsalerecord();
        $searchModel = new CustomerSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        ...
        // get your HTML raw content without any layouts or scripts
        $content = $this->renderPartial('_report-cs-pdf', [
            'customers' => $customers,
            'grades' => $grades,
            'filter' => $filter,
            'model' => $model,
        ...
        $pdf = new Pdf([
            ...
            'cssInline' => 'table,tr,td{border:none !important;}',
            // set mPDF properties on the fly
            'options' => ['title' => 'Preview Cashsalerecord: '.$plant_id],
            // call mPDF methods on the fly
            'methods' => [
                //'SetHeader'=>[''],
                //'SetFooter'=>['{PAGENO}'],
